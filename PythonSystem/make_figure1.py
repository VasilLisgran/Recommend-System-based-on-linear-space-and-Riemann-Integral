"""make_figure1.py -- acc@1 and recall@3 across the lambda grid for the two
accounts that qualify under the disjoint-window protocol, with the
lambda = 1.0 no-decay control marked.
